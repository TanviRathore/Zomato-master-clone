...
function ReviewModal({isOpen, setIsOpen, ...props}) {
                                    ...
                                    <form className="flex flex-col gap-4">
                                        <div className=" w-full flex flex-col gap-2">
                                            ...
                                            <input 
                                                ...
                                                className="w-full border border-gray-400 focus:border-Zomato-400 focus:outline-none rounded-lg px-2 py-1"
                                            />
                                        </div>
                                        <div className="w-full flex flex-col gap-2">
                                            <label className="w-full flex flex-col gap-2">Review Text</label>
                                            <textarea
                                                id="reviewText"
